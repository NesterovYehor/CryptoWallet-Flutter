                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Spacer(),
                            Text("Holdings", style: subTitleStyle.copyWith(color: Theme.of(context).colorScheme.secondary),),
                            const Spacer(),
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final coin = apiState.coins.firstWhere(
                              (c) => c.symbol == portfolioCoin.index,
                            );
                            return CoinListTileWidget(
                                    marketCapRank: coin.marketCapRank,
                                    image: portfolioCoin.imageUrl,
                                    symbol: portfolioCoin.index,
